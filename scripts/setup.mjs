...
// Agent Claw -- Auto-detect environment and write .env.local
// Usage: npm run setup
...
async function main() {
  console.log()
  console.log(bold('  Agent Claw Setup'))
  ...
  // Write
  const content = [
    '# Agent Claw -- generated by npm run setup',
  ...
  if (!gatewayUp) {
    ...
    console.log(`    2. Start Agent Claw:   ${dim('npm run dev')}`)
  } else {
